...
def process_videos(input_dir, output_dir, gpu_id=1):
...
# 入力と出力ディレクトリの設定
input_dir = "/workspace/data/data/new_data_selected/non_ASD/HipOA"
output_dir = "/workspace/data/data/TEST_HipOA_7"
process_videos(input_dir, output_dir, gpu_id=1)