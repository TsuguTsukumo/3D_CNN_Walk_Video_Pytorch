...
def get_parameters():
    ...
    parser.add_argument('--split_data_path', type=str,
                        default="/workspace/data/Test_1_only_side_error/", help="split dataset path")
    parser.add_argument('--split_pad_data_path', type=str, default="/workspace/data/Test_1_only_side_error/",
