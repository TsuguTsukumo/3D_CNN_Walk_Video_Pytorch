...
# 動画データの元ディレクトリ 
fileDir = "/workspace/data/split_pad_dataset_512/raw"

# 分割したデータを保存する先のディレクトリ
tarDir = "/workspace/data/split_pad_dataset_512"

# トレーニングデータの割合 (80%をトレーニング、残りを検証用に)
rate = 0.8

# バージョンフラグと病気フラグ (デフォルト値)
version_flag = ["train", "val"]
disease_flag = ["ASD", "ASD_not"]

# 関数を呼び出す
random_split_video(fileDir, tarDir, rate, version_flag, disease_flag)